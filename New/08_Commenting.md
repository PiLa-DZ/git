...
- Team Mentions:
  ...
  you can mention an entire team (@my-org/backend-devs) to notify everyone at once.
...
- The Options: +1 (Agree), -1 (Disagree), 😄 (Laugh), 🎉 (Celebrate), ❤️ (Heart), and 👀 (Eyes).
...
- Single Comment: A standalone message at the bottom of the PR.
- Review Comment: A comment attached to a specific line of code.
- Suggestion:
